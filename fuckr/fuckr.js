...
(function() {
  var authenticateFactory, chat, chatController, cmToLocalUnit, fuckr, gramToLocalUnit, gui, highResSrc, lastTimeActive, managedFields, nativeMenuBar, nonDraggable, pinpoint, profiles, profilesController, rememberPassword, settingsController, updateLocation, weightInput;
  ...
  angular.module('fuckr.directives', ['ngStorage']).directive('rememberPassword', ['$localStorage', rememberPassword]).directive('nonDraggable', nonDraggable);
