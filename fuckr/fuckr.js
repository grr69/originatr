...
(function() {
  var authenticateFactory, chat, chatController, fuckr, gui, highResSrc, jacasr, nativeMenuBar, pinpoint, profiles, profilesController, updateLocation, updateProfileController;
  ...
  fuckr.config([
    '$httpProvider', '$routeProvider', function($httpProvider, $routeProvider) {
      ...
      ref = ['/profiles/:id?', '/chat/:id?', '/updateProfile'];
      results1 = [];
