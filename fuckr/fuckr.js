...
(function() {
  var authenticateFactory, chat, chatController, cmToLocalUnit, fuckr, gramToLocalUnit, gui, highResSrc, nativeMenuBar, pinpoint, profiles, profilesController, settingsController, updateLocation;
  ...
  angular.module('profilesController', ['ngtimeago', 'ngRoute', 'ngStorage', 'ngMap', 'profiles', 'pinpoint']).directive('highResSrc', [highResSrc]).filter('gramToLocalUnit', ['$localStorage', gramToLocalUnit]).filter('cmToLocalUnit', ['$localStorage', cmToLocalUnit]).controller('profilesController', ['$scope', '$interval', '$localStorage', '$routeParams', '$window', 'profiles', 'pinpoint', profilesController]);
  ...
  settingsController = function($scope, $http, $localStorage, profiles, uploadImage) {
    ...
    $scope.updateProfileAttribute = function(attribute) {
      var data;
      data = {};
  ...
  angular.module('settingsController', ['file-model', 'uploadImage']).controller('settingsController', ['$scope', '$http', '$localStorage', 'profiles', 'uploadImage', settingsController]);
  ...
  if (typeof process !== 'undefined' && process.versions['node-webkit']) {
    ...
    fuckr = angular.module('fuckr', ['ngRoute', 'profiles', 'profilesController', 'authenticate', 'chat', 'chatController', 'settingsController', 'updateLocation']);
    fuckr.config([
