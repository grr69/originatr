...
(function() {
  var authenticateFactory, chat, chatController, cmToLocalUnit, emoji, fuckr, gramToLocalUnit, gui, highResSrc, lastTimeActive, managedFields, nativeMenuBar, nonDraggable, onEnter, pinpoint, profiles, profilesController, rememberPassword, scrollDownOnNewConversation, settingsController, updateLocation, weightInput;
  ...
  angular.module('profilesController', ['ngRoute', 'ngStorage', 'ngMap', 'profiles', 'pinpoint']).filter('gramToLocalUnit', ['$localStorage', gramToLocalUnit]).filter('cmToLocalUnit', ['$localStorage', cmToLocalUnit]).filter('lastTimeActive', lastTimeActive).service('managedFields', managedFields).controller('profilesController', ['$scope', '$interval', '$localStorage', '$routeParams', '$window', '$injector', 'profiles', 'pinpoint', profilesController]);
  ...
  angular.module('fuckr.directives', ['ngStorage']).directive('rememberPassword', ['$localStorage', rememberPassword]).directive('nonDraggable', nonDraggable).directive('highResSrc', highResSrc).directive('emoji', emoji);
