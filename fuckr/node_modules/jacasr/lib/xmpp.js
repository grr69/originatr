...
Client = function (conf) {
  ...
  function resourceBindings () {
    ...
    function sessionBindings () {
      ...
      function enableAcknowledgement () {
        self.write('<enable xmlns="' + NS_ACK + '"/>');
      }
      stream_events_manager.once('start|session|' + NS_SESSION, enableAcknowledgement);
      stream_events_manager.once('end|enabled|' + NS_ACK, sendPresenceInformation);
    }
  ...
  function onAcknowledgementRequest() {
    self.write('<a xmlns="' + NS_ACK + '" h="' + self.sequenceNumber + '"/>');
    self.sequenceNumber += 1;
  }
...
//     sys.puts('setSecure');
  ...
  function init () {
    ...
    self.jid = conf.login + '@' + conf.domain;
  ...
  stream_events_manager = (new events.EventEmitter)
    ...
    .on('start|r|' + NS_ACK, onAcknowledgementRequest)
